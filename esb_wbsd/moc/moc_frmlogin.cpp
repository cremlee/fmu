...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_frmLogin_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 30, 19)
    ...
    "frmLogin\0on_btnLogin_clicked\0\0"
...
const QMetaObject frmLogin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_frmLogin.data,
      qt_meta_data_frmLogin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_frmLogin.stringdata))
        return static_cast<void*>(const_cast< frmLogin*>(this));
